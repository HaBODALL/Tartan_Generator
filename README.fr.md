...
├── Random_Tartan_Generator_P5_JS_1_0.js   # Logique p5.js principale pour la génération de Tartans
...
Distribué sous licence MIT (ou licence par défaut du projet). Consultez le dépôt pour plus de détails.
